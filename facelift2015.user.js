...
function createOptionsMenu(){
    ...
    var tempfunc = function(type, header, edit, del){
        ...
        for(var i = 0; i < mylist.length; i++){
            ...
            type.prettyPrint(mytable, mykey, mylist[i][mykey], edit, del);
        }
    };
...
if(typeof(data) === 'undefined' || typeof(data.get("firsttime")) === 'undefined' || data.get("firsttime") === true){
    ...
    registerScriptReal(true, configHandler);
    ...
    registerScriptReal(true, utilityfunc);
    ...
    var scraper = {
        ...
        "setupGlobals": function(){
            //expose global configuration settings for use by everything
            window.data = new configObj("data_",
                {
                    'firsttime': true,
                    'username': 'unknown',
                    'userid': 0,
    ...
    registerScriptReal(true, scraper);
